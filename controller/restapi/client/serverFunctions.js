...
exports.getPlayerProfile = async function (req, res, next) {
  try {
    ...
    var totalEarning = await dividendContractInstance
      .totalDividendReceivedIndividual(playerAddress)
      .call();
    totalEarning = totalEarning / 1000000;
    var lastDrop = await dividendContractInstance
      .previousDivAmountUser(playerAddress)
      .call();
