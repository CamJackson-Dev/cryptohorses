  ...
  try {
    ...
    if (
      ...
      (d = staticObject.fromSun(d)),
        $('#playerDividend').text(
          parseFloat(d).toFixed(2).toLocaleString('en') + ' TRX'
        );
      ...
      (c =
        0 === l
          ? '<tr><td>' +
            ...
            '</td><td>' +
            d +
            ' TRX</td><td style="color:#ff5959">-</td></tr>'
          : '<tr><td>' +
            t +
            '</td><td>' +
            horseNames[n] +
...
async function startLiveevents() {
  try {
    var e = await staticObject.trx.getContract(gameLocation1Contract),
